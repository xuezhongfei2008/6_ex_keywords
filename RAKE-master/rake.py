...
def calculate_word_scores(phraseList):
    ...
    for item in word_frequency:
        ...
        print("####JJJJJ",word_degree[item] ,word_frequency[item] ,item)
...
if test:
    text = "In the latest episode of podcast, The Digital Factory"
    # Split text into sentences
    sentenceList = split_sentences(text)
    # sentenceList=['任性付','是','怎么','开通','啊','任性付']
